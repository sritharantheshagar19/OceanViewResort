...
<%
    ...
    if(roomTypes == null) {
        roomTypes = new String[]{"STANDARD", "DELUXE", "SUITE", "FAMILY", "BEACH_VIEW"};
    }
%>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="reservation-badge">
                <i class="fas fa-hashtag"></i> Reservation #<%= reservation.getReservationId() %>
            </div>
        </div>
        ...
        <div class="form-body">
            ...
            <!-- Edit Form -->
            <form action="ReservationServlet" method="post" id="editForm" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper" id="guestNameWrapper">
                        ...
                        <input type="text" name="guest_name" id="guestName"
                               ...
                               value="<%= reservation.getGuestName() %>"
                               required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper" id="phoneWrapper">
                        ...
                        <input type="tel" name="contact_number" id="phoneNumber"
                               ...
                               value="<%= reservation.getContactNumber() %>"
                               required>
                    </div>
                    ...
                    <div class="input-wrapper" id="roomTypeWrapper">
                        ...
                        <select name="room_type" id="roomType" required>
                            ...
                            <% for (String type : roomTypes) { %>
                                <option value="<%= type %>" <%= type.equals(reservation.getRoomType()) ? "selected" : "" %>>
                                    <%= type %>
                                </option>
                            <% } %>
                        </select>
                ...
                <div class="action-buttons">
                    <a href="ReservationServlet?action=list" class="btn-secondary">
            ...
            <div class="footer-links">
                <a href="ReservationServlet?action=view&id=<%= reservation.getReservationId() %>">
                    <i class="fas fa-eye"></i>
                    View Details
                </a>
                <a href="#" onclick="return confirmDelete();" style="color: #e74c3c;">
    ...
    <script>
        ...
        function validateAddress() {
            ...
            if (addr.length === 0) {
                setInvalid(addressWrapper, addressFeedback, 'Address is required');
            } else if (addr.length < 5) {
                setInvalid(addressWrapper, addressFeedback, 'Please enter a complete address');
            } else {
                setValid(addressWrapper, addressFeedback, '✓ Valid address');
            }
        }
        ...
        function confirmDelete() {
            if (confirm('Are you sure you want to delete this reservation? This action cannot be undone.')) {
                window.location.href = 'ReservationServlet?action=delete&id=<%= reservation.getReservationId() %>';
            }
            return false;
        }
        ...
        const inputs = [guestName, address, phoneNumber, roomType, checkIn, checkOut];
        ...
        // Run initial validations on page load
